...
import { WithdrawalLog, WithdrawalLogSchema } from './models/withdrawalLog.schema';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: WithdrawalLog.name, schema: WithdrawalLogSchema },
  ...
  providers: [ArtworkService, ExhibitionService, ArtistService, InteractionService, ReviewService, WithdrawalService, AuthService],
})
